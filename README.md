...
Circuit Diagram – (I used an Arduino Uno instead, as they didn’t have ESP8266)
...
[Insert flowchart or pseudocode diagram here illustrating the logic:]
...
Screenshot for MyMQTT app showing results from mobile
